...
/*------------- dingxin.wang 20161125 ---------------*/
opts.onClose = function () { if (fn) { fn(); } };
/*--------------------------------------------------*/
...
/* 
//_3b6[_3b8].panel("open").panel("resize",_3bc.expandP); //20160729 dingxin.wang
_3b6[_3b8].panel("resize", _3bc.expandP);
*/
...
_4f9(item);
_4fb.call(this, item);
$(item.target).trigger('afterOnClick',[item]); //2016-12.12 dingxin.wang
};
}else{
if(_4f4.menu){
...
if(ed && ed.actions && ed.actions.resize){
