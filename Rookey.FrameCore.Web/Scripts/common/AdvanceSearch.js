    ...
    if (formFields && formFields.length > 0) {
        ...
        $.each(formFields, function (i, obj) {
            ...
            if (controlType == 0 || controlType == 12 || controlType == 15 || controlType == 100 || obj.ForeignModuleName) { //字符串字段或外键字段
                ...
                var tempMidOrMname = fieldDom.attr('moduleId') ? fieldDom.attr('moduleId') : moduleId;
                FieldBindAutoCompleted(tempDom, tempMidOrMname, obj.Sys_FieldName, null, function (dom, item, fieldName, tempParamObj) {
