...
function SaveForm(backFun) {
    ...
    var data = { formName: formName, editMode: editMode, fieldNames: fieldNames, rowNums: rowNums, colNums: colNums, canEdits: canEdits, moduleId: moduleId, formId: formId, fieldIds: fieldIds };
    $.ajax({
        type: 'post',
