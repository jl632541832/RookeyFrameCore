...
namespace Rookey.Frame.EntityBase
{
    ...
    public class BaseEntity
    {
        ...
        /// 创建日期
        /// </summary>
        [FieldConfig(Display = "创建日期", ControlType = (int)ControlTypeEnum.DateTimeBox, IsEnableForm = false, IsAllowGridSearch = false, HeadWidth = 150, HeadSort = 1005)]
        public DateTime? CreateDate { get; set; }

        /// <summary>
        /// 修改日期
        /// </summary>
        [FieldConfig(Display = "修改日期", ControlType = (int)ControlTypeEnum.DateTimeBox, IsEnableForm = false, IsAllowGridSearch = false, HeadWidth = 150, HeadSort = 1006)]
