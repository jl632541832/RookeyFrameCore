...
namespace Rookey.Frame.Model.OrgM
{
    ...
    public class OrgM_Duty : BaseOrgMEntity
    {
        ...
        /// 编码
        /// </summary>
        [FieldConfig(Display = "编码", IsFrozen = true, IsRequired = true, IsUnique = true, RowNum = 1, ColNum = 1, HeadSort = 1)]
        [StringLength(100)]
        ...
        /// 生效日期
        /// </summary>
        [FieldConfig(Display = "生效日期", ControlType = (int)ControlTypeEnum.DateBox, RowNum = 3, ColNum = 2, IsRequired = true, DefaultValue = "currDate", HeadSort = 6)]
