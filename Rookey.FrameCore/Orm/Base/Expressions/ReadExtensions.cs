...
namespace ServiceStack.OrmLite
{
    public static class ReadExtensions
    {
        ...
        internal static List<T> LoadSelect<T>(this IDbCommand dbCmd, SqlExpression<T> expression = null, List<string> fieldNames = null)
        {
            return dbCmd.LoadListWithReferences<T, T>(expression, fieldNames);
        }
