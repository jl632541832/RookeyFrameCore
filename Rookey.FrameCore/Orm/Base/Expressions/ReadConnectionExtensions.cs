...
namespace ServiceStack.OrmLite
{
    public static class ReadConnectionExtensions
    {
        ...
        /// </summary>
        public static List<T> Select<T>(this IDbConnection dbConn, SqlExpression<T> expression, List<string> fieldNames = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.Select(expression, fieldNames));
        }
        ...
        /// <para>db.Select&lt;Person&gt;(x =&gt; x.Age &gt; 40)</para>
        /// </summary>
        public static T Single<T>(this IDbConnection dbConn, SqlExpression<T> expression, List<string> fieldNames = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.Single(expression, fieldNames));
        }
        ...
        /// </summary>
        public static List<T> LoadSelect<T>(this IDbConnection dbConn, SqlExpression<T> expression = null, List<string> fieldNames = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.LoadSelect(expression, fieldNames));
        }
