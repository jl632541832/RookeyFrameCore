...
namespace ServiceStack.OrmLite
{
    public interface IOrmLiteDialectProvider
    {
        ...
        string ToSelectStatement(Type tableType, List<string> fieldNames, string sqlFilter, params object[] filterParams);
        ...
        string GetColumnNames(ModelDefinition modelDef, List<string> fieldNames = null);
        ...
        string ToColumnExistsStatement(Type modelType, string fieldName);
