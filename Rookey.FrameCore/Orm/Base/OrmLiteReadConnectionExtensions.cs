...
namespace ServiceStack.OrmLite
{
    public static class OrmLiteReadConnectionExtensions
    {
        ...
        /// </summary>
        public static T SingleById<T>(this IDbConnection dbConn, object idValue, List<string> fieldNames = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.SingleById<T>(idValue, fieldNames));
        }
        ...
        /// <returns></returns>
        public static DataTable ExecuteQuery(this IDbConnection dbConn, string sql, Dictionary<string, object> dict = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.ExecuteQuery(sql, dict));
        }
        ...
        /// </summary>
        public static T LoadSingleById<T>(this IDbConnection dbConn, object idValue, List<string> fieldNames = null)
        {
            return dbConn.Exec(dbCmd => dbCmd.LoadSingleById<T>(idValue, fieldNames));
        }
