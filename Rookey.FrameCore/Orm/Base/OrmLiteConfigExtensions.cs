        ...
        internal static ModelDefinition GetModelDefinition(this Type modelType)
        {
            ...
            foreach (var propertyInfo in objProperties)
            {
                if (propertyInfo.GetIndexParameters().Length > 0)
                    continue; //Is Indexer
                if (propertyInfo.Name == "AutoIncrmId" && OrmLiteConfig.DialectProvider.GetType().Name == "MySqlDialectProvider")
                    continue;
                ...
                List<Type> autoIncrementTypes = new List<Type>() { typeof(long), typeof(Int32), typeof(Int64) };
