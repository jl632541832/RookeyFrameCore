...
namespace ServiceStack.OrmLite
{
    ...
    public static class OrmLiteDDLExtensions
    {
        ...
        public static bool ColumnIsExists(this IDbConnection dbConn,Type modelType, string fieldName)
        {
            var command = OrmLiteConfig.DialectProvider.ToColumnExistsStatement(modelType, fieldName);
            DataTable dt = dbConn.ExecuteQuery(command);
            return dt != null && dt.Rows != null && dt.Rows.Count > 0 && Convert.ToInt32(dt.Rows[0][0]) > 0;
        }
