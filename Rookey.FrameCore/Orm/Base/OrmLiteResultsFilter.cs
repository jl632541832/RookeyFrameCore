...
namespace ServiceStack.OrmLite
{
    public interface IOrmLiteResultsFilter
    {
        ...
        DataTable ExecuteQuery(IDbCommand dbCmd);
    ...
    public class OrmLiteResultsFilter : IOrmLiteResultsFilter, IDisposable
    {
        ...
        public DataTable ExecuteQueryResult { get; set; }

        public Func<IDbCommand, DataTable> ExecuteQueryFn { get; set; }
        ...
        public DataTable ExecuteQuery(IDbCommand dbCmd)
        {
            Filter(dbCmd);
            if (ExecuteQueryFn != null)
            {
                return ExecuteQueryFn(dbCmd);
            }
