    ...
    public static class OrmLiteReadExtensions
    {
        ...
        internal static List<T> SelectFmt<T>(this IDbCommand dbCmd, string sqlFilter, params object[] filterParams)
        {
            return dbCmd.ConvertToList<T>(
                OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, sqlFilter, filterParams));
        }
        ...
        {
            return dbCmd.ConvertTo<T>(OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, filter, filterParams));
        }

        [ThreadStatic]
        private static Type lastQueryType;
        internal static void SetFilter<T>(this IDbCommand dbCmd, string name, object value, List<string> fieldNames = null)
        {
            dbCmd.Parameters.Clear();
            ...
            dbCmd.CommandText = GetFilterSql<T>(dbCmd, fieldNames);
        ...
        internal static string GetFilterSql<T>(this IDbCommand dbCmd, List<string> fieldNames = null)
        {
            ...
            return OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), fieldNames, sb.ToString());
        }
        ...
        internal static T SingleById<T>(this IDbCommand dbCmd, object value, List<string> fieldNames = null)
        {
            if (!dbCmd.CanReuseParam<T>(ModelDefinition<T>.PrimaryKeyName))
                SetFilter<T>(dbCmd, ModelDefinition<T>.PrimaryKeyName, value, fieldNames);
        ...
        internal static T Single<T>(this IDbCommand dbCmd, string sql, object anonType)
        {
            ...
            return dbCmd.ConvertTo<T>(OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, sql));
        }
        ...
        internal static List<T> SelectNonDefaults<T>(this IDbCommand dbCmd, string sql, object anonType = null)
        {
            ...
            return dbCmd.ConvertToList<T>(OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, sql));
        }
        ...
        internal static IEnumerable<T> ColumnLazy<T>(this IDbCommand dbCmd, string sql, object anonType = null)
        {
            if (anonType != null) dbCmd.SetParameters<T>(anonType, excludeDefaults: false);
            var dialectProvider = OrmLiteConfig.DialectProvider;
            dbCmd.CommandText = dialectProvider.ToSelectStatement(typeof(T), null, sql);
        ...
        {
            dbCmd.CommandText = OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, filter, filterParams);
        ...
        internal static List<T> Column<T>(this IDbCommand dbCmd, string sql, object anonType = null)
        {
            ...
            return dbCmd.Column<T>(OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, sql));
        }
        ...
        internal static bool Exists<T>(this IDbCommand dbCmd, string sql, object anonType = null)
        {
            ...
            var result = dbCmd.Scalar(OrmLiteConfig.DialectProvider.ToSelectStatement(typeof(T), null, sql));
            return result != null;
        }
        ...
        internal static bool ExistsFmt<T>(this IDbCommand dbCmd, string sqlFilter, params object[] filterParams)
        {
            ...
            var result = dbCmd.Scalar(OrmLiteConfig.DialectProvider.ToSelectStatement(fromTableType, null, sqlFilter, filterParams));
            return result != null;
        }
        ...
        internal static T LoadSingleById<T>(this IDbCommand dbCmd, object value, List<string> fieldNames = null)
        {
            var row = dbCmd.SingleById<T>(value, fieldNames);
            if (row == null)
                return default(T);
