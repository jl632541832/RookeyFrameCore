...
namespace Rookey.Frame.UIOperate
{
    ...
    public class EasyUIFrame : UIFrameFactory
    {
        ...
        public override string GetMainPageHTML()
        {
            ...
            //--快捷菜单 start---
            sb.Append("<span class=\"header-right\">");
            sb.Append("<a id=\"btnQuickMenuSet\" href=\"javascript:void(0)\" class=\"easyui-linkbutton easyui-tooltip\" data-options=\"iconCls:'eu-icon-grid',plain:true,hideEvent:'none',content:function(){return $('#quickOpToolbar');},");
            sb.Append("onShow:function(){var t=$(this);t.tooltip('tip').focus().unbind().bind('blur',function(){t.tooltip('hide');});}\">快捷菜单</a>");
            sb.Append("</span>");
            sb.AppendFormat("<span id=\"span_logo\" class=\"head-left\" style=\"background:url({0}) no-repeat left;\">", WebConfigHelper.GetCurrWebLogo());
            sb.AppendFormat("<span>&nbsp;</span>");
            sb.Append("</span>");
            //--快捷菜单 end---
            //--系统模块搜索开始---
            sb.Append("<div class=\"head-search\">");
            ...
            //--系统模块搜索结束---
            //--系统标题开始---
            sb.Append("<span class=\"head-title-left\">");
            ...
            sb.Append("<div id=\"tabs\" class=\"easyui-tabs\" fit=\"true\" border=\"false\" th=\"" + ConstDefine.TAB_HEAD_HEIGHT + "\" data-options=\"tools:'#tabs_toolbar',onClose:function(title,index){},onSelect:function(title,index){if(typeof(OverOnSelect)=='function'){OverOnSelect(title,index);}},tabHeight:" + ConstDefine.TAB_HEAD_HEIGHT.ToString() + "\">");
            ...
            sb.Append("<div id=\"quickOpToolbar\" style=\"background:#eef5f9\">");
            ...
            if (userQuckMenus.Count > 0)
            {
                for (int i = 0; i < userQuckMenus.Count; i++)
                {
                    ...
                    nodeJson += "}}}";
                    sb.AppendFormat("<td style=\"width:33%\"><a href=\"#\" class=\"easyui-linkbutton\" data-options=\"iconCls:'{0}',plain:true\" onclick=\"TreeNodeOnClick({2})\">{1}</a></td>", string.IsNullOrEmpty(menu.Icon) ? "eu-icon-search" : menu.Icon, string.IsNullOrEmpty(menu.Display) ? menu.Name : menu.Display, nodeJson);
                }
                sb.Append("</tr>");
            }
            else
        ...
        public override string GetChangePwdHTML()
        {
            ...
            sb.Append("<td><input id=\"oldPwd\" name=\"oldPwd\" class=\"easyui-textbox\" type=\"password\" data-options=\"required:true,iconCls:'eu-icon-password',iconAlign:'left',missingMessage:null\" style=\"width:300px\"></td>");
            sb.Append("</tr>");
            sb.Append("<tr>");
            sb.Append("<td>新设密码：</td>");
            sb.Append("<td><input id=\"newPwd1\" name=\"newPwd1\" class=\"easyui-textbox\" type=\"password\" data-options=\"required:true,iconCls:'eu-icon-changePwd',iconAlign:'left',missingMessage:null\" style=\"width:300px\"></td>");
            sb.Append("</tr>");
            sb.Append("<td>再次输入：</td>");
            sb.Append("<td><input id=\"newPwd2\" name=\"newPwd2\" class=\"easyui-textbox\" type=\"password\" data-options=\"required:true,iconCls:'eu-icon-changePwd',iconAlign:'left',missingMessage:null\" style=\"width:300px\"></td>");
            sb.Append("</tr>");
            sb.Append("</table>");
            sb.Append("</form>");
        ...
        public override string GetAddQuckMenuHTML()
        {
            ...
            if (dic.Count > 0)
            {
                ...
                sb.Append("</td>");
                sb.Append("<td>");
                sb.Append("<table id=\"rightGrid\" class=\"easyui-datagrid\" style=\"width: 350px;height:350px;\" data-options=\"fitColumns:false,selectOnCheck:true,checkOnSelect:true,rownumbers:true,idField:'MenuId'\">");
                sb.Append("<thead>");
                sb.Append("<tr>");
                sb.Append("<th data-options=\"field:'MenuId',checkbox:true\">菜单Id</th>");
                sb.Append("<th data-options=\"field:'MenuName',align:'left',width:136\">功能菜单</th>");
                sb.Append("<th data-options=\"field:'Operate',width:150\">操作</th>");
                sb.Append("</tr>");
                sb.Append("</thead>");
                List<Sys_Menu> userQuckMenus = SystemOperate.GetUserQuckMenus(CurrUser.UserId);
        ...
        /// <returns></returns>
        public override string GetGridHTML(Guid moduleId, DataGridType gridType = DataGridType.MainGrid, string condition = null, string where = null, Guid? viewId = null, string initModule = null, string initField = null, Dictionary<string, object> otherParams = null, bool detailCopy = false, List<string> filterFields = null, Guid? menuId = null, bool isGridLeftTree = false, HttpRequest request = null)
        {
            string html = string.Empty;
            #region 准备参数
            UserInfo currUser = this.CurrUser;
            //用户视图
            Sys_Grid grid = gridType == DataGridType.RecycleGrid || gridType == DataGridType.MyDraftGrid ? SystemOperate.GetDefaultGrid(moduleId) : (viewId.HasValue && viewId.Value != Guid.Empty ? SystemOperate.GetGrid(viewId.Value) : SystemOperate.GetUserDefaultGrid(currUser.UserId, moduleId));
            if (grid == null) return string.Empty;
            GridTypeEnum gridTypeOfEnum = grid.GridTypeOfEnum; //视图类型
            if (gridTypeOfEnum == GridTypeEnum.NoAttachView)
                gridTypeOfEnum = GridTypeEnum.System;
            ...
            {
                Guid? tmpFormId = null;
                if (module.ParentId.HasValue && request != null && request.QueryEx("moduleId").ObjToGuid() == module.ParentId.Value &&
                    gridType == DataGridType.EditDetailGrid && isEnabledFlow && otherParams != null &&
                    otherParams.ContainsKey("p_todoId") && otherParams.ContainsKey("node"))
                {
                    //明细流程审批时，允许编辑明细时
                    string flowNode = otherParams["node"].ObjToStr();
                    Guid p_todoId = otherParams["p_todoId"].ObjToGuid();
                    if (p_todoId != Guid.Empty && !string.IsNullOrEmpty(flowNode))
                    {
                        string tmpMsg = string.Empty;
                        Bpm_WorkToDoList tmpTodo = CommonOperate.GetEntity<Bpm_WorkToDoList>(x => x.ParentId == p_todoId, null, out tmpMsg);
                        if (tmpTodo != null)
                        {
                            Guid tmpWorkflowId = BpmOperate.GetWorkflowIdByTodoId(tmpTodo.Id);
                            Bpm_WorkNode tmpWorkNode = BpmOperate.GetAllWorkNodes(x => x.Bpm_WorkFlowId == tmpWorkflowId && x.Name == flowNode).FirstOrDefault();
                            if (tmpWorkNode != null && tmpWorkNode.Sys_FormId.HasValue && tmpWorkNode.Sys_FormId.Value != Guid.Empty)
                                tmpFormId = tmpWorkNode.Sys_FormId.Value;
                        }
                    }
                }
                else if (module.ParentId.HasValue && request != null && request.QueryEx("moduleId").ObjToGuid() == module.ParentId.Value && request.QueryEx("todoId").ObjToGuid() != Guid.Empty)
                {
                    //明细流程走完或者明细流程未启动，主模块流程正在走
                    bool isNoStart = false; //明细流程未启动标识
                    string mainFlowNode = request.QueryEx("node").ObjToStr(); //主流程节点名称
                    Guid todoId = request.QueryEx("todoId").ObjToGuid(); //主流程待办ID
                    if (!string.IsNullOrEmpty(mainFlowNode))
                    {
                        Guid workflowId = BpmOperate.GetWorkflowIdByTodoId(todoId);
                        Bpm_WorkNode workNode = BpmOperate.GetAllWorkNodes(x => x.Bpm_WorkFlowId == workflowId && x.Name == mainFlowNode).FirstOrDefault();
                        //当前主流程节点为子流程启动节点时
                        if (workNode != null && workNode.SubFlowTypeOfEnum == SubFlowTypeEnum.ChildFlow && workNode.Bpm_WorkFlowSubId.HasValue && workNode.Bpm_WorkFlowSubId.Value != Guid.Empty)
                        {
                            isNoStart = true;
                        }
                    }
                    if (!isNoStart)
                    {
                        tmpFormId = SystemOperate.GetUserForm(currUser.UserId, moduleId).Id;
                    }
                }
                form = SystemOperate.GetUserFinalForm(currUser, moduleId, tmpFormId);
            }
            #endregion
            #region 获取缓存key
            ...
            if (gridType == DataGridType.EditDetailGrid && form != null) //针对编辑页面网格特殊处理
            {
                ...
                foreach (Sys_GridField gf in gridFields.Where(x => x.IsVisible))
                {
                    ...
                    if (ff == null && gf.Sys_FieldId.HasValue)
                    {
                        Sys_Field sysFieldTemp = SystemOperate.GetFieldById(gf.Sys_FieldId.Value);
                        if (sysFieldTemp != null && !string.IsNullOrEmpty(sysFieldTemp.ForeignModuleName)) //外键字段
                        {
                            ff = formFields.Where(x => x.Sys_FieldId == gf.Sys_FieldId).FirstOrDefault();
                        }
                    }
                    if (ff == null) continue;
                    if (editMode == (int)ModuleEditModeEnum.GridRowEdit && (ff.IsAllowAdd != false || ff.IsAllowEdit != false) && !string.IsNullOrEmpty(ff.EditorFormatter))
                        gf.Width = ff.Width;
            ...
            if (gridType == DataGridType.EditDetailGrid && request != null && request.QueryEx("todoId").ObjToGuid() != Guid.Empty) //主从审批界面，明细不允许新增、删除、复制、导入
            {
                Dictionary<string, string> dicConn = CommonOperate.GetConditionDic(condition);
                object tmpExp = CommonOperate.GetQueryCondition(moduleId, dicConn);
                string tmpMsg = string.Empty;
                long detailCount = CommonOperate.Count(out tmpMsg, moduleId, false, tmpExp);
                if (detailCount > 0) //存在明细数据时不允许新增
                {
                    gridButtons = gridButtons.Where(x => x.ButtonTagId != "btnAdd" && x.ButtonTagId != "btnAuxiliary" && x.ButtonTagId != "btnCopy" && x.ButtonTagId != "btnDelete" && x.ButtonTagId != "btnImportModel").ToList();
                }
            }
            if (gridButtons.Count > 0 && request != null)
            {
                if (request.QueryEx("nb").ObjToInt() == 1) //不显示操作按钮，只显示查看及导出
                {
                    Sys_GridButton viewBtn = gridButtons.Where(x => x.ButtonTagId == "btnViewRecord").FirstOrDefault();
                    Sys_GridButton exportBtn = gridButtons.Where(x => x.ButtonTagId == "btnExportModel").FirstOrDefault();
                    gridButtons = gridButtons.Where(x => (viewBtn != null && x.Id == viewBtn.Id) || (exportBtn != null && x.Id == exportBtn.Id) || (exportBtn != null && exportBtn.ParentId.HasValue && exportBtn.ParentId.Value != Guid.Empty && x.Id == exportBtn.ParentId.Value)).ToList();
                }
                else if (request.QueryEx("nbc").ObjToInt() == 1) //不显示操作按钮，显示查看、导出及自定义按钮
                {
                    Sys_GridButton exportBtn = gridButtons.Where(x => x.ButtonTagId == "btnExportModel").FirstOrDefault();
                    gridButtons = gridButtons.Where(x => x.IsSystem != true || x.ButtonTagId == "btnViewRecord" || x.ButtonTagId == "btnExportModel" || (exportBtn != null && exportBtn.ParentId.HasValue && exportBtn.ParentId.Value != Guid.Empty && x.Id == exportBtn.ParentId.Value)).ToList();
                }
            }
            ...
            //列表视图、综合视图、自定义视图可加载附属模块
            bool canLoadAttach = grid.GridTypeOfEnum == GridTypeEnum.System || grid.GridTypeOfEnum == GridTypeEnum.Comprehensive || grid.GridTypeOfEnum == GridTypeEnum.Custom;
            if (GlobalSet.IsAllowAttachModule && gridType == DataGridType.MainGrid && canLoadAttach) //主网格才加载附属
            {
                //用户是否绑定了下方附属模块
            ...
            string gridDataOption = " data-options=\"region:'center',border:false\" class=\"gridUIpanel\" ";
            if (gridType == DataGridType.MainGrid)
            {
                if (isLoadAttachModule) //有附属模块
                {
                    int w = currUser.ClientBrowserWidth - (request != null && request.QueryEx("nfm").ObjToInt() == 1 ? 0 : ConstDefine.MAIN_LEFT_MENU_WIDTH) - ConstDefine.GRID_FIX_HEIGHT - ConstDefine.SCROLL_WIDTH - 4;
                ...
                else //没有附属模块
                {
                    if (!string.IsNullOrWhiteSpace(grid.TreeField) && !grid.IsTreeGrid) //左侧树存在
                    {
                        int w = currUser.ClientBrowserWidth - ConstDefine.MAIN_LEFT_MENU_WIDTH - ConstDefine.GRID_LEFT_MENU_WIDTH - ConstDefine.GRID_FIX_HEIGHT;
                        reginMainWstr = string.Format("width:{0}px", w.ToString());
                    }
                }
            }
            if (gridType == DataGridType.DialogGrid || gridType == DataGridType.Other || gridType == DataGridType.FlowGrid)
            {
                ...
                if (gridType == DataGridType.FlowGrid)
                {
                    int w = currUser.ClientBrowserWidth - (request != null && request.QueryEx("nfm").ObjToInt() == 1 ? 0 : ConstDefine.MAIN_LEFT_MENU_WIDTH) - ConstDefine.SCROLL_WIDTH - ConstDefine.GRID_FIX_HEIGHT - ConstDefine.SCROLL_WIDTH;
                    if (isShowFullPath) w -= 200; //针对嵌入其他系统
                    if (isGridLeftTree) //左侧树存在
                        w -= ConstDefine.GRID_LEFT_MENU_WIDTH;
                    reginMainWstr = string.Format("width:{0}px", w.ToString());
                }
                else if (gridType == DataGridType.DialogGrid)
                {
                    reginMainWstr = "padding:5px 10px 5px 10px;";
                }
                else
                {
            ...
            sb.AppendFormat("<div id=\"{0}\" moduleId=\"{1}\" moduleName=\"{2}\" tableName=\"{3}\" titleKey=\"{4}\"{6} style=\"{5}\" parentModuleName=\"{7}\" isflow=\"{8}\">",
            ...
            if (gridTypeOfEnum == GridTypeEnum.Comprehensive || gridTypeOfEnum == GridTypeEnum.ComprehensiveDetail)
            {
                otherGridUrl += "&viewId=" + grid.Id.ToString();
                if (gridTypeOfEnum == GridTypeEnum.ComprehensiveDetail)
            ...
            if (request != null)
            {
                if (request.QueryEx("rsf").ObjToInt() == 1) //重新发起流程标识
                    gridUrl += "&rsf=1";
                if (request.QueryEx("nfp").ObjToInt() == 1) //不过滤权限标识
                    gridUrl += "&nfp=1";
            }
            ...
            if (otherParams != null && otherParams.Count > 0) //添加网格参数
            {
                ...
                if (otherParams.ContainsKey("node") && otherParams["node"].ObjToStr() != string.Empty)
                    gridUrl += string.Format("&node={0}", HttpUtility.UrlEncode(otherParams["node"].ObjToStr()));
            }
            ...
            string idField = "Id";
            if (gridTypeOfEnum == GridTypeEnum.ComprehensiveDetail)
                idField = "TempDetailId";
            else if (gridType == DataGridType.EditDetailGrid)
                idField = string.Empty;
            string reqMethod = "get";
            try
            {
                //if (request != null && (request.Browser.Browser.ToLower() == "ie" || request.Browser.Browser.ToLower() == "internetexplorer"))
                //    reqMethod = "post";
            }
            catch { }
            string gridOptions = string.Format("url:'{0}',pagination:{1},idField:'{7}',striped:true,rownumbers:{5},{2},collapsible:true,fitColumns:false,selectOnCheck:true,checkOnSelect:true,singleSelect:{4},toolbar:'#grid_toolbar_{3}',method:'" + reqMethod + "',multiSort:{6}",
                gridUrl, paging, pageInfo, moduleId.ToString(), singleSelect, "true", gridFields.Where(x => x.Sys_FieldName != "Id" && x.IsAllowSort).ToList().Count > 1 ? "true" : "false", idField);
            bool isDetailExpand = otherParams != null && otherParams.ContainsKey("detailExpandMode") && otherParams["detailExpandMode"].ObjToStr() == "true";
            if (isDetailExpand)
            {
                gridOptions += string.Format(",title:'{0}'", module.Display);
            }
            ...
            else if (editMode == (int)ModuleEditModeEnum.GridRowEdit && (gridType == DataGridType.EditDetailGrid || gridType == DataGridType.ViewDetailGrid || gridType == DataGridType.FlowGrid || gridType == DataGridType.InnerDetailGrid))
            {
                ...
                if (formFields.Select(x => x.RowEditRowNo).Where(x => x >= 0).Distinct().Count() > 1)
                {
                    ...
                    if (isLeftTree)
                        maxW -= ConstDefine.GRID_LEFT_MENU_WIDTH;
                    gridOptions += ",view:detailview,detailFormatter:function(index,row){return DetailGridRowFormatter('" + gridId + "','" + moduleId.ToString() + "','" + module.Name + "',index,row," + maxW + ");}";
                }
            }
            ...
            if (gridType == DataGridType.MainGrid || gridType == DataGridType.RecycleGrid || gridType == DataGridType.MyDraftGrid)
            {
                ...
                if (gridType == DataGridType.MainGrid && isLoadAttachModule)
                {
                    ...
                    int w = currUser.ClientBrowserWidth - (request != null && request.QueryEx("nfm").ObjToInt() == 1 ? 0 : ConstDefine.MAIN_LEFT_MENU_WIDTH) - ConstDefine.SCROLL_WIDTH - ConstDefine.GRID_FIX_HEIGHT - 4; //屏幕宽度减去滚动条宽
                    if (isShowFullPath) w -= 200; //针对嵌入其他系统
                    if (!string.IsNullOrWhiteSpace(grid.TreeField) && !grid.IsTreeGrid) //左侧树存在
                        w -= ConstDefine.GRID_LEFT_MENU_WIDTH;
            ...
            else if (gridType == DataGridType.DialogGrid || gridType == DataGridType.FlowGrid)
            {
                if (gridType == DataGridType.FlowGrid)
                {
                    int w = currUser.ClientBrowserWidth - (request != null && request.QueryEx("nfm").ObjToInt() == 1 ? 0 : ConstDefine.MAIN_LEFT_MENU_WIDTH) - ConstDefine.SCROLL_WIDTH - ConstDefine.GRID_FIX_HEIGHT - ConstDefine.SCROLL_WIDTH; //屏幕宽度减去滚动条宽
                    if (isShowFullPath) w -= 200; //针对嵌入其他系统
                    if (isGridLeftTree) //左侧树存在
                        w -= ConstDefine.GRID_LEFT_MENU_WIDTH;
            ...
            //else if (gridType == DataGridType.EditDetailGrid || gridType == DataGridType.ViewDetailGrid)
            //{
            //    int w = currUser.ClientBrowserWidth - (request != null && request["nfm"].ObjToInt() == 1 ? 0 : ConstDefine.MAIN_LEFT_MENU_WIDTH) - ConstDefine.SCROLL_WIDTH - ConstDefine.GRID_FIX_HEIGHT - ConstDefine.SCROLL_WIDTH - 12;
            //    tableStyle += string.Format("style=\"width:{0}px !important;\"", w);
            //}
            //其他重写参数
            ...
            if (isEnabledFlow && (gridType == DataGridType.MainGrid || gridType == DataGridType.FlowGrid || gridType == DataGridType.ViewDetailGrid)) //添加流程图标列
            {
                ...
                if (gridType == DataGridType.MainGrid && gridTypeOfEnum == GridTypeEnum.ComprehensiveDetail)
                {
                ...
                sb.Append("<th data-options=\"title:'',field:'flow_" + mIdStr + "',width:33,align:'center',formatter:function(value, row, index){return FlowIconFormatter(value, row, index,'" + mIdStr + "','" + mNameStr + "');}\"></th>");
                sb.Append("<th data-options=\"title:'状态',field:'FlowStatus',width:55,align:'center',formatter:function(value, row, index){return FlowStatusFormatter(value, row, index,'" + mIdStr + "','" + mNameStr + "');}\"></th>");
            }
            ...
            sb.Append("</table>");
            //网格工具栏和搜索框
            string gbStyle = gridType == DataGridType.DialogGrid ? "width:880px" : string.Empty;
            if (isDetailExpand)
                gbStyle = "background:#d1e8ff !important;";
            sb.AppendFormat("<div id=\"grid_toolbar_{0}\" class=\"noprint toolbar datagrid-toolbar crmUI clearfix\" style=\"{1}\">", moduleId.ToString(), gbStyle);
            ...
            //工具栏
            toolSb.AppendFormat("<div name=\"btns\" class=\"gaidbtns\" style=\"height:{0}px;line-height:{0}px;float:left;{1}\">", ConstDefine.GRID_TOOLBAR_HEIGHT.ToString(), string.Format("margin-top:{0}px{1}", (ConstDefine.GRID_TOOLBAR_HEIGHT - 26) / 2, isMutiSearchStyle ? ";width:100%" : string.Empty));
            if (gridType != DataGridType.DialogGrid && gridType != DataGridType.Other && gridType != DataGridType.InnerDetailGrid && gridType != DataGridType.RecycleGrid && gridType != DataGridType.MyDraftGrid)
            {
                ...
                foreach (Sys_GridButton button in topButtons)
                {
                    ...
                    if (button.ButtonTagId != "btnStartFlow" && SystemOperate.IsFileMenuButton(moduleId, button.Id)) //是文件菜单按钮
                    {
                        ...
                        mm_html.AppendFormat("<div id=\"mm_btn_{0}\" class=\"noprint\" style=\"width:70px;\">", button.Id.ToString());
            ...
            else if (gridType == DataGridType.RecycleGrid) //回收站列表
            {
                ...
                toolSb.AppendFormat("<a id=\"btn_del\" style=\"float:left;\" href=\"#\" class=\"easyui-linkbutton\" iconCls=\"eu-icon-del\" plain=\"true\" onclick=\"Delete(this)\" recycle=1 {2}>删除</a>", moduleId.ToString(), module.Name, btnAttr);
            }
            else if (gridType == DataGridType.MyDraftGrid) //我的草稿列表
            {
                ...
                toolSb.AppendFormat("<a id=\"btn_del\" style=\"float:left;\" href=\"#\" class=\"easyui-linkbutton\" iconCls=\"eu-icon-del\" plain=\"true\" onclick=\"Delete(this)\" isHardDel=1 {2}>删除</a>", moduleId.ToString(), module.Name, btnAttr);
            }
            toolSb.Append("</div>");
            #endregion
            #region 搜索框和视图
            ...
            if (gridType != DataGridType.EditDetailGrid)
            {
                ...
                string searchFloat = isMutiSearchStyle ? "left;width:100%;margin-top:4px;margin-left:15px" : (gridType != DataGridType.Other && gridType != DataGridType.InnerDetailGrid ? "right" : "left");
                //自定义搜索UI
                string simpleSearchHtml = string.Empty;
                string searchStyle = isMutiSearchStyle ? string.Empty : string.Format("margin-top:{0}px;", (ConstDefine.GRID_TOOLBAR_HEIGHT - 26) / 2);
                if (isDetailExpand)
                {
                    searchStyle += "background:#d1e8ff;";
                }
                searchSb.AppendFormat("<div id=\"div_search{0}\" class=\"northSearch clearfix {3}\" style=\"float:{1};{2}\">", moduleId.ToString(), searchFloat, searchStyle, gridType != DataGridType.MainGrid && gridType != DataGridType.RecycleGrid && gridType != DataGridType.MyDraftGrid ? (gridType == DataGridType.DialogGrid ? "dialogtable" : "nomaintable") : string.Empty);
                if (string.IsNullOrEmpty(simpleSearchHtml)) //不存在用户自定义搜索UI
                {
                    if (hasSearchFields) //有搜索字段
                    {
                        ...
                        if (!isMutiSearchStyle)
                        {
                            ...
                            //简单搜索框
                            searchSb.AppendFormat("<div id=\"div_sampleSearch\" class=\"northSearchTex \" style=\"float:left;display:{0}\">", displayComplexSearch ? "none" : "block");
                                ...
                                if (formField != null)
                                {
                                    ...
                                    switch (formField.ControlTypeOfEnum)
                                    {
                                        ...
                                        case ControlTypeEnum.NumberBox:
                                            controlWidth = isMutiSearchStyle ? 100 : 60;
                                            break;
                                        case ControlTypeEnum.DateBox:
                                        case ControlTypeEnum.DateTimeBox:
                                            controlWidth = isMutiSearchStyle ? 100 : 175;
                                            break;
                                    }
                        ...
                        {
                            searchSb.AppendFormat("<div id=\"div_complexSearch\" style=\"float:left;{0}\" mutistyle=\"{1}\">", !isMutiSearchStyle && gridType != DataGridType.DialogGrid ? "display:none;" : string.Empty, isMutiSearchStyle ? "1" : string.Empty);
                            searchSb.Append("<form method=\"post\" id=\"searchform\">");
                            searchSb.Append("<div id=\"mainContent\" class=\"northSearchli clearfix\">");
                            searchSb.AppendFormat("<table style=\"height:{0}px;line-height:{0}px;\" rh=\"{0}\"><tr>", ConstDefine.COMPLEX_SEARCH_TR_HEIGHT);
                            int n = 0;
                            foreach (Sys_Field key in fieldInputHtmls.Keys)
                            {
                                if (isMutiSearchStyle && n > 0 && n % rm == 0)
                                {
                                    searchSb.Append("</tr><tr>");
                                }
                                n++;
                                searchSb.AppendFormat("<td style=\"text-align:right\" class=\"searchTh\"><span style=\"margin-left:5px\">{0}：</span></td>", key.Display);
                                searchSb.Append("<td class=\"searchTD\">");
                            ...
                            searchSb.Append("</div>");
                            searchSb.AppendFormat("<a id=\"btn_search\" moduleId=\"{0}\" moduleName=\"{1}\" gridId=\"{2}\" viewId=\"{3}\" href=\"#\" title=\"点击搜索\" class=\"easyui-linkbutton easyui-tooltip \" iconCls=\"eu-icon-search\" plain=\"true\" onclick=\"ComplexSearch(this)\" style=\"{4}\">查询</a>", moduleId.ToString(), module.Name, gridId, grid.Id.ToString(), !isMutiSearchStyle && gridType != DataGridType.DialogGrid ? "display:none;" : string.Empty);
                            if (!isMutiSearchStyle)
                            {
                                //切换搜索按钮
                                searchSb.AppendFormat("<a id=\"btn_changeSearch\" href=\"#\" title=\"切换搜索方式\" class=\"easyui-linkbutton easyui-tooltip btnwhite\" iconCls=\"eu-p2-icon-feed_magnify\" plain=\"true\" onclick=\"ChangeSearchStyle(this)\"></a>", moduleId.ToString(), module.Name, gridId, grid.Id.ToString());
                            }
                            searchSb.Append("<a id=\"btn_clear\" href=\"#\" title=\"清除搜索内容\" class=\"easyui-linkbutton easyui-tooltip btnwhite\" iconCls=\"eu-icon-clear\" plain=\"true\" onclick=\"ClearSearch(this)\">清除</a>");
                        }
                        //高级搜索按钮
                        if (gridType != DataGridType.InnerDetailGrid)
                        {
                            searchSb.AppendFormat("<a id=\"btn_advanceSearch{0}\" moduleId=\"{0}\" moduleName=\"{1}\" gridId=\"{2}\" viewId=\"{3}\" href=\"#\" title=\"高级搜索\" class=\"easyui-linkbutton easyui-tooltip btnwhite\" iconCls=\"eu-icon-advance_search\" plain=\"true\" onclick=\"AdvanceSearch(this)\"></a>", moduleId.ToString(), module.Name, gridId, grid.Id.ToString());
                        }
                        if (!isMutiSearchStyle && gridType == DataGridType.MainGrid && module.Name != "待办任务")
                        {
                            ...
                            //启用过滤行搜索按钮
                            searchSb.AppendFormat("<a id=\"btn_filterSearch\" moduleId=\"{0}\" moduleName=\"{1}\" gridId=\"{2}\" viewId=\"{3}\" isrf=\"{4}\" href=\"#\" title=\"{5}\" class=\"easyui-linkbutton btnwhite\" iconCls=\"{6}\" plain=\"true\" onclick=\"OpenOrCloseRowFilterSearch(this)\"></a>", moduleId.ToString(), module.Name, gridId, grid.Id.ToString(), isrf.ToString(), filterTitle, filterIcon);
                        }
                    }
                }
                else //存在用户自定义搜索UI
                ...
                if (gridType == DataGridType.MainGrid)
                {
                    ...
                    searchSb.AppendFormat("<a id=\"btn_gridSet{0}\" moduleId=\"{0}\" moduleName=\"{1}\" gridId=\"{2}\" viewId=\"{3}\" viewName=\"{4}\" treeField=\"{5}\" gridUrl=\"{6}\" href=\"#\" title=\"单击可切换列表视图--当前视图：{7}\" class=\"easyui-linkbutton btnwhite\" iconCls=\"eu-icon-grid \" plain=\"true\" onclick=\"GridSet(this)\"></a>",
                            moduleId.ToString(), module.Name, gridId, grid.Id.ToString(), grid.Name, treeField, tempGridUrl, grid.Name);
                    //附属模块及明细显示设置按钮
                    if (gridTypeOfEnum != GridTypeEnum.ComprehensiveDetail && SystemOperate.GetAttachModules(moduleId).Count > 0)
                    {
                        searchSb.AppendFormat("<a id=\"btn_attach_set_{0}\" moduleId=\"{0}\" moduleName=\"{1}\" class=\"easyui-linkbutton easyui-tooltip btnwhite\" data-options=\"iconCls:'eu-icon-cog',plain:true\" title=\"附属模块显示设置\" onclick=\"AttachModuleSet(this)\"></a>", moduleId.ToString(), module.Name);
                    }
                    //我的草稿图标
                ...
                if (gridType == DataGridType.MainGrid || gridType == DataGridType.FlowGrid || gridType == DataGridType.ViewDetailGrid)
                {
                    ...
                    if (module.IsEnabledRecycle && isContainsDelBtn)
                    {
                        ...
                        searchSb.AppendFormat("<a id=\"btn_recycle\" moduleId=\"{0}\" moduleName=\"{1}\" moduleDisplay=\"{2}\" href=\"#\" title=\"点击进入回收站\" class=\"easyui-linkbutton easyui-tooltip btnwhite\" iconCls=\"eu-icon-recycle\" plain=\"true\" onclick=\"GoToRecycle(this)\"></a>", tempModuleId.ToString(), tempModuleName, tempModuleDisplay);
                    }
                }
                searchSb.Append("</div>");
            }
        ...
        private static string GetGridFieldFormatter(Sys_Module module, Sys_GridField field, DataGridType gridType, string gridId, int editMode, string otherFormatParams, out string editorStr, Guid userId)
        {
            ...
            if (string.IsNullOrEmpty(formatStr))
            {
                ...
                if (!CommonDefine.BaseEntityFields.Contains(sysField.Name) && !string.IsNullOrWhiteSpace(sysField.ForeignModuleName) && gridType != DataGridType.RecycleGrid && gridType != DataGridType.MyDraftGrid && gridType != DataGridType.EditDetailGrid) //外键模块处理
                {
                    ...
                    if (foreignModule != null && PermissionOperate.HasModuleBrowerPermission(userId, foreignModule.Id))
                    {
                ...
                {
                    CommonOperate.OperateRecord<Sys_GridField>(field, ModelRecordOperateType.Edit, out errMsg, new List<string>() { "FieldFormatter" }, false);
                }
            }
            if (string.IsNullOrEmpty(editorStr))
            {
                ...
                if (editMode == (int)ModuleEditModeEnum.GridRowEdit)
                {
                    ...
                    {
                        Sys_FormField formField = SystemOperate.GetUserFormField(userId, module.Id, sysField); //SystemOperate.GetDefaultFormSingleField(sysField);
                        if (formField != null && (formField.IsAllowAdd != false || formField.IsAllowEdit != false) && formField.ControlTypeOfEnum != ControlTypeEnum.LabelBox) //允许编辑时
                        {
                            if (gridType != DataGridType.EditDetailGrid || otherFormatParams == null || formField.RowEditRowNo <= 0 || field.IsVisible)
                            {
                                if (PermissionOperate.CanEditField(userId, module.Id, sysField.Name)) //有编辑权限
                                {
                                    ...
                                    if (string.IsNullOrEmpty(editorStr))
                                    {
                                        editor = SystemOperate.GetFieldEditor(SystemOperate.GetModuleById(sysField.Sys_ModuleId.Value), sysField, formField);
                                        editorStr = string.IsNullOrEmpty(editor) ? string.Empty : string.Format(",editor:{0}", editor);
                                        if (!string.IsNullOrEmpty(editorStr))
                                        {
                                            field.EditorFormatter = editorStr;
                                            CommonOperate.OperateRecord<Sys_GridField>(field, ModelRecordOperateType.Edit, out errMsg, new List<string>() { "EditorFormatter" }, false);
                                        }
                                    }
                                }
                            }
        ...
        public override string GetAdvanceSearchHTML(Guid moduleId, Guid? viewId)
        {
            ...
            sb.Append("<div style=\"width:380px;height:100%;\">");
            sb.Append("<div id=\"mainContent\" class=\"content contentpanel\">");
            sb.Append("<table class=\"advance_table\" border=\"0\" cellpadding=\"1\" cellspacing=\"2\" style=\"width:300px;line-height:30px;table-layout:fixed;\">");
        ...
        public override string GetQuickEditViewHTML(Guid moduleId, Guid? viewId)
        {
            ...
            List<Sys_GridField> leftGridFields = defaultGrid.GridFields != null && defaultGrid.GridFields.Count > 0 ? defaultGrid.GridFields : SystemOperate.GetDefaultGridFields(moduleId);
            ...
            leftGridFields = leftGridFields.Where(x => x.IsVisible).ToList();
            ...
            sb.Append("}");
            sb.Append("</style>");
            sb.Append("<table style=\"width: 100%; height: 100%; line-height: 35px;\">");
            sb.Append("<tr>");
            sb.Append("<td colspan=\"3\">");
            sb.Append("<table style=\"width:100%;\">");
            sb.Append("<tr>");
            ...
            if (foreignModules.Count > 0 || detailModules.Count == 1) //只有一个明细模块
            {
                ...
                if (detailModules.Count == 1)
                {
                    ...
                    List<Sys_GridField> tempDetailGridFields = SystemOperate.GetUserGridFields(CurrUser.UserId, tempDetailModule.Id);
                ...
                if (foreignModules.Count > 0)
                {
                    ...
                    {
                        List<Sys_GridField> tempGridFields = SystemOperate.GetUserGridFields(CurrUser.UserId, tempModule.Id);
            ...
            sb.Append("<tr>");
            sb.Append("<td>");
            sb.Append("<table id=\"leftGrid\" class=\"easyui-datagrid\" style=\"width: 180px; height: 330px;\" data-options=\"fitColumns:true,selectOnCheck:true,checkOnSelect:true,rownumbers:true,idField:'Id'" + otherOptions + "\">");
            sb.Append("<thead>");
            sb.Append("<tr>");
            ...
            sb.Append("</td>");
            sb.Append("<td>");
            sb.Append("<table id=\"rightGrid\" class=\"easyui-datagrid\" style=\"width: 350px; height: 330px;\" data-options=\"fitColumns:true,selectOnCheck:true,checkOnSelect:true,rownumbers:true,idField:'Id'" + otherOptions + "\">");
            sb.Append("<thead>");
            sb.Append("<tr>");
            sb.Append("<th data-options=\"field:'Id',checkbox:true\"></th>");
            sb.Append("<th data-options=\"field:'FieldName',hidden:true,width:0\">字段名称</th>");
        ...
        public override string GetGridSetHTML(Guid moduleId)
        {
            ...
            sb.Append("<div class=\"noEmpty \" style=\"width:400px;height:100%;padding:10px;\">");
            ...
            sb.AppendFormat("<a href=\"#\" id=\"btnDelView\" moduleId=\"{0}\" class=\"easyui-linkbutton\" iconCls=\"eu-icon-del\" plain=\"true\" onclick=\"DelView(this)\"></a>", moduleId.ToString());
            sb.Append("</td></tr>");
            sb.Append("</table>");
            sb.Append("</div></div></form>");
        ...
        public override string GetAttachModuleSetHTML(Guid moduleId)
        {
            Sys_Module module = SystemOperate.GetModuleById(moduleId);
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("<table id=\"attachModuleTable\" moduleName=\"{0}\" style=\"margin-left:5px;margin-top:5px;line-height:35px;\">", module.Name);
            sb.Append("<thead>");
            sb.Append("<tr>");
        ...
        private string GetNewEditFormGroupTable(Sys_Module module, Sys_Form form, List<IGrouping<int, Sys_FormField>> rows, List<Sys_FormField> formFields, string tableWidth, object model, object copyModel, ref List<object> fieldObjects, List<string> canViewFields, List<string> canOpFields, bool? isCache = false, bool isRestartFlow = false)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("<table class=\"thinBorder  editThinBorder\" border=\"0\" cellpadding=\"1\" cellspacing=\"2\" style=\"width:{0};table-layout:fixed;\">", tableWidth);
            int maxCol = 0;
            ...
            foreach (var row in rows)
            {
                ...
                foreach (Sys_FormField field in row)
                {
                    ...
                    //获取受当前字段关联的字段
                    List<string> linkFieldsList = formFields.Where(x => x.DefaultValue.ObjToStr() == "{" + sysField.Name + "}").Select(x => x.Sys_FieldName).Where(x => !string.IsNullOrEmpty(x)).ToList();
                    ...
                    sb.AppendFormat("<td style=\"padding:0px;width:{0}\"{1}>", ipWidthStr, colSpan);
                    sb.Append(inputHtml);
                    sb.Append("</td>");
                    if (residueCs > 0)
                    ...
                    if (foreignModule != null)
                    {
                        ...
                        fieldObjects.Add(new
                        {
                            Sys_FieldName = sysField.Name.StartsWith("Other") ? sysField.Name + "Name" : sysField.Name.Substring(0, sysField.Name.Length - 2) + "Name",
        ...
        /// <param name="request">请求对象</param>
        /// <returns></returns>
        public override string GetEditFormHTML(Guid moduleId, Guid? id, string gridId = null, Guid? copyId = null, bool showTip = false, Guid? todoTaskId = null, Guid? formId = null, HttpRequest request = null)
        {
            string html = string.Empty;
            #region 前置验证
            Sys_Module module = SystemOperate.GetModuleById(moduleId);
            ...
            if (string.IsNullOrEmpty(detailHtml)) //没有自定义明细编辑页面
            {
                //走通用明细编辑
                #region 通用明细编辑网格
                if (hasDetail)
                {
                    ...
                    if (detailModules != null && detailModules.Count > 0)
                    {
                        ...
                        bool isDetailExpand = detailModules.Count > 1 && form.ModuleEditModeOfEnum == ModuleEditModeEnum.TabFormDetailExpand; //表单明细展开
                        string marginStyle = isDetailExpand ? " style=\"margin-top:10px;margin-bottom:10px;\"" : string.Empty;
                        if (!detailTopDisplay)
                        {
                            if (isDetailExpand)
                            {
                                detailTab.Append("<div id=\"detailExpandDiv\">");
                                otherParams.Add("detailExpandMode", "true");
                            }
                            else
                            {
                        ...
                        foreach (Sys_Module detailModule in detailModules)
                        {
                            ...
                            if (tempId != Guid.Empty) //构造过滤条件
                            {
                                ...
                                if (detailFields != null)
                                    conditionField = detailFields.Where(x => x.ForeignModuleName == module.Name && x.Name.EndsWith("Id") && x.Name != "CreateUserId" && x.Name != "ModifyUserId").FirstOrDefault();
                                if (conditionField != null)
                                    condition = "{" + conditionField.Name + ":" + tempId + "}";
                            }
                            detailTab.AppendFormat("<div title=\"{0}\"{1}>", detailModule.Name, marginStyle);
                            if (isParentTodo && BpmOperate.IsEnabledWorkflow(detailModule.Id))
                            {
                                ...
                                if (request != null && request.QueryEx("node").ObjToStr() != string.Empty)
                                    otherParams.Add("node", request.QueryEx("node").ObjToStr());
                            }
            ...
            sb.Append("<div id=\"divEditForm\" class=\"content  editContentForm\" style=\"display:block\">");
            //表单按钮
            ...
            sb.AppendFormat("<div id=\"editFormTabs\" class=\"{0}\" style=\"width:100%;{2}:{1};\" data-options=\"onSelect:OnEditFormTabSelect{3}\"><div class=\"detailCon  mb10\">", tabCls, tabHeight, tabHeightKey, thHeightStr);
            foreach (var tab in tabs)
            {
                ...
                sb.Append("<div id=\"mainContent\" class=\"content editContentNew\">");
                ...
                foreach (var group in groups)
                {
                    ...
                    sb.AppendFormat("<div class=\"viewItem {0}\" title=\"{1}\" style=\"width:{2};padding:{3}px;margin-bottom:0px;\" data-options=\"collapsible:true\">", panelCls, group.FirstOrDefault().GroupName, panelWidth, ConstDefine.FORM_PANEL_PADDING.ToString());
        ...
        private string GetNewViewFormGroupTable(Sys_Module module, Sys_Form form, List<IGrouping<int, Sys_FormField>> rows, string tableWidth, Guid id, object model, bool isRecycle, ref List<object> fieldObjects, List<string> canViewFields, List<string> canEditFields, bool hasRecoredEdit, bool? isCache = false)
        {
            if (fieldObjects == null)
                fieldObjects = new List<object>();
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("<table class=\"thinBorder seeThinBorder\" border=\"0\" cellpadding=\"1\" cellspacing=\"2\" style=\"width:{0};table-layout:fixed;\">", tableWidth);
            int maxCol = 0;
            foreach (var row in rows)
            {
                int count = row.Count();
            ...
            foreach (var row in rows)
            {
                ...
                foreach (Sys_FormField field in row)
                {
                    ...
                    //label
                    string splitChar = string.IsNullOrEmpty(form.RightToken) ? "：" : form.RightToken;
                    sb.AppendFormat("<th style=\"width:{0}px;text-align:right\">{1}{2}</th>", labelWidth.ToString(), sysField.Display, splitChar);
                    //data
                    bool canView = canViewFields == null || canViewFields.Count == 0 || canViewFields.Contains(sysField.Name);
                    ...
                    sb.AppendFormat("<td style=\"width:{0}\"{1}>{2}</td>", ipWidthStr, colSpan, valueSpan);
                    if (residueCs > 0)
                        sb.AppendFormat("<td style=\"width:100%;border-left-color:#fff\" colspan=\"{0}\">&nbsp;</td>", residueCs.ToString());
                    Type fieldType = SystemOperate.GetFieldType(module.Id, sysField.Name);
                    string fieldTypeStr = fieldType != null ? fieldType.ToString() : string.Empty;
                    ...
                    if (foreignModule != null)
                    {
                        ...
                        fieldObjects.Add(new
                        {
                            Sys_FieldName = sysField.Name.EndsWith("Id") ? sysField.Name.Substring(0, sysField.Name.Length - 2) + "Name" : sysField.Name + "Name",
                            Display = sysField.Display,
                            ControlType = field.ControlType,
                            ForeignModuleName = foreignModuleName,
                            IsTitleKey = isTitleKey,
        ...
        /// <param name="request">请求对象</param>
        /// <returns></returns>
        public override string GetViewFormHTML(Guid moduleId, Guid id, string gridId = null, string fromEditPageFlag = null, bool isRecycle = false, bool showTip = false, Guid? formId = null, HttpRequest request = null)
        {
            string html = string.Empty;
            #region 前置验证
            Sys_Module module = SystemOperate.GetModuleById(moduleId);
                ...
                if (hasDetail)
                {
                    ...
                    if (detailModules.Count > 0)
                    {
                        ...
                        if (!detailTopDisplay)
                        {
                            ...
                            {
                                detailTab.AppendFormat("<div id=\"detailTab\" class=\"easyui-tabs\" data-options=\"fit:false,border:true,tabHeight:{0}\" style=\"min-height:150px;\">", ConstDefine.TAB_HEAD_HEIGHT.ToString());
                            }
                        }
                        foreach (Sys_Module detailModule in detailModules)
                        {
                            ...
                            detailTab.AppendFormat("<div title=\"{0}\"{1}>", detailModule.Name, marginStyle);
                            string editGridHtml = GetGridHTML(detailModule.Id, DataGridType.ViewDetailGrid, condition, null, null, null, null, otherParams, false, null, null, false, request);
                            detailTab.Append(editGridHtml);
                            detailTab.Append("</div>");
                        }
                        if (!detailTopDisplay)
            ...
            if (isEnabledFlow)
            {
                ...
                if (detailModules != null && detailModules.Count == 1)
                {
                    Sys_Module detailM = detailModules.FirstOrDefault();
                    bool detailIsFlow = BpmOperate.IsEnabledWorkflow(detailM.Id);
                    string tempMsg = string.Empty;
                    object tempObj = CommonOperate.GetEntity(detailM.Id, null, string.Format("{0}Id='{1}' AND FlowStatus IS NOT NULL AND FlowStatus>0", module.TableName, id), out tempMsg);
                    if (detailIsFlow && tempObj != null)
                        isParentTodo = true;
                }
            ...
            StringBuilder sb = new StringBuilder();
            string titleKeyDisplay = SystemOperate.GetModuleTitleKeyDisplay(moduleId);
            sb.Append("<div id=\"divEditForm\" class=\"content editContentDetail\" style=\"display:block\">");
            if (toolTags.Where(x => x.ClickMethod.ObjToStr().StartsWith("PrintModel")).Count() > 0) //包含通用打印
            {
                string moduleDisplay = !string.IsNullOrEmpty(module.Display) ? module.Display : module.Name;
                sb.AppendFormat("<div class=\"printhide\">{0}</div>", moduleDisplay);
            }
            //顶部表单按钮
            sb.Append("{topBtnsHtml}");
            //表单tag
            ...
            sb.AppendFormat("<div class=\"detailCon {0} mb10\" style=\"width:100%;{2}:{1};\" {3}>", tabCls, tabHeight, tabHeightKey, thHeightStr);
            foreach (var tab in tabs)
            {
                string tabTitle = string.IsNullOrEmpty(tab.FirstOrDefault().TabName) ? "主信息" : tab.FirstOrDefault().TabName;
                sb.AppendFormat("<div title=\"{0}\">", tabTitle);
                sb.Append("<div class=\"content   viewContentNew\">");
                var groups = tab.OrderBy(x => x.RowNo).ThenBy(x => x.ColNo).GroupBy(x => x.GroupName).ToList();
                foreach (var group in groups)
                {
                    var rows = group.OrderBy(x => x.RowNo).ThenBy(x => x.ColNo).GroupBy(x => x.RowNo).ToList();
            ...
            sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}Scripts/common/ViewForm.js?r={1}\"></script>", domainPath, viewFormJsr);
            if (string.IsNullOrEmpty(gridId))
            {
                //模块自定义js
                sb.Append(UIOperate.GetModelJsHTML(module, request));
        ...
        public override string GetEditFieldHTML(Guid moduleId, string fieldName, Guid recordId)
        {
            ...
            Sys_Module module = SystemOperate.GetModuleById(moduleId);
            StringBuilder sb = new StringBuilder();
            Sys_FormField field = SystemOperate.GetNfDefaultFormSingleField(moduleId, fieldName);
            if (field != null && field.IsAllowEdit.HasValue && field.IsAllowEdit.Value)
            {
                ...
                sb.AppendFormat("<span id=\"lable_{0}\" style=\"float:left;width:{1}px;height:{2}px;line-height:{2}px;text-align:left;\">{3}:</span>",
                    fieldName, labelWidth.ToString(), ConstDefine.FORM_CONTROL_HEIGHT.ToString(), sysField.Display);
                //input span
        ...
        public override string GetBatchEditHTML(Guid moduleId, int selectRecords, int pageRecords)
        {
            ...
            sb.Append("<table style=\"width: 100%;\">");
            //允许批量编辑的字段
            string codeField = SystemOperate.GetBillCodeFieldName(moduleId);
            List<string> primarykeys = new List<string>(); //唯一标识字段集合
            if (!string.IsNullOrEmpty(module.PrimaryKeyFields))
            {
                string[] token = module.PrimaryKeyFields.Split(",".ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
                if (token.Length > 0)
                    primarykeys = token.ToList();
            }
            List<Sys_FormField> batchEditFields = this.CurrUser != null ? SystemOperate.GetUserFormFields(this.CurrUser.UserId, moduleId, true).Where(x => x.Sys_FieldId.HasValue && x.IsAllowBatchEdit.HasValue && x.IsAllowBatchEdit.Value && x.Sys_FieldName != "Id" && x.Sys_FieldName != codeField).ToList() : SystemOperate.GetDefaultBatchEditFields(moduleId, true).Where(x => x.Sys_FieldName != codeField).ToList();
            if (primarykeys.Count > 0) //排除唯一标识字段
                batchEditFields = batchEditFields.Where(x => !primarykeys.Contains(x.Sys_FieldName)).ToList();
            ...
            sb.Append("<div id=\"mainContent\">");
            sb.Append("<table style=\"width: 100%;line-height:35px;\">");
            foreach (Sys_FormField field in batchEditFields)
            {
                ...
                ObjectHelper.CopyValue<Sys_FormField>(field, tempField);
                tempField.IsRequired = false;
                string inputHtml = GetFormFieldInputHTML(moduleId, tempField, sysField, null, false, null, null, null, null, true, false, CurrUser);
                sb.Append(inputHtml);
                sb.Append("</td>");
                sb.Append("</tr>");
            }
        ...
        /// <param name="viewId">视图ID</param>
        /// <returns></returns>
        public override string GetExportModelHTML(Guid moduleId, int cc, Guid? viewId = null)
        {
            StringBuilder sb = new StringBuilder();
            ...
            string errMsg = string.Empty;
            string where = " IsDeleted=0 AND IsDraft=0";
            Guid tempModuleId = moduleId;
            Sys_Grid gridView = viewId.HasValue && viewId.Value != Guid.Empty ? SystemOperate.GetGrid(viewId.Value) : null;
            if (gridView != null && gridView.GridTypeOfEnum == GridTypeEnum.ComprehensiveDetail)
            {
                Sys_Module detailModule = SystemOperate.GetDetailModules(moduleId).FirstOrDefault();
                if (detailModule != null)
                    tempModuleId = detailModule.Id;
            }
            long count = CommonOperate.Count(out errMsg, tempModuleId, true, null, where, null, null, CurrUser);
            List<Sys_GridField> gridFields = gridView != null ? SystemOperate.GetGridFields(gridView.Id) : SystemOperate.GetUserGridFields(CurrUser.UserId, tempModuleId);
            if (gridFields.Count > 0)
            {
                ...
                {
                    if (!field.Sys_FieldId.HasValue || field.Sys_FieldId.Value == Guid.Empty)
                        continue;
                    Sys_Field sysField = SystemOperate.GetFieldById(field.Sys_FieldId.Value);
                    if (sysField == null || !sysField.Sys_ModuleId.HasValue)
                        continue;
                    object obj = SystemOperate.GetFieldCommonInfo(sysField.Sys_ModuleId.Value, field.Sys_FieldName);
            ...
            sb.Append("<div style=\"padding: 5px 5px 5px 20px;\">");
            sb.Append("<table style=\"width:100%;height:100%;line-height:30px;\">");
            sb.Append("<tr>");
            sb.Append("<td>");
            sb.Append("<table style=\"width:450px;\"><tr>");
            ...
            sb.Append("<table style=\"width:602px;height:220px;\" id=\"conditionGrid\" class=\"easyui-datagrid\" data-options=\"title:'条件设置',onSelect:function(rowIndex, rowData){$('#conditionGrid').datagrid('unselectAll');}\">");
            sb.Append("<thead><tr>");
            sb.Append("<th data-options=\"field:'Field',width:150,align:'center',editor:{type:'combobox',required:true,options:{valueField:'Sys_FieldName',textField:'Display',url:'/" + GlobalConst.ASYNC_STSTEM_CONTROLLER_NAME + "/LoadViewFields.html?flag=1&" + (gridView == null ? "moduleId" : "viewId") + "=" + (gridView == null ? moduleId : gridView.Id) + "',onSelect:OnFieldSelected}}\">字段名</th>");
            ...
            sb.Append("<th data-options=\"field:'Group',width:80,align:'center',editor:{type:'combobox',options:{valueField:'Id',textField:'Name',data:[{Id:'And',Name:'并且'},{Id:'Or',Name:'或者'}]}}\">分组</th>");
            sb.Append("<th data-options=\"field:'Op',width:100,align:'center',formatter:function(value,row,index){return FormatOp(value,row,index);}\">操作</th>");
            sb.Append("</tr></thead>");
            sb.Append("</table>");
            sb.Append("</div>");
            sb.Append("</td>");
        ...
        /// <param name="request">请求对象</param>
        /// <returns></returns>
        public override string GetDialogTreeHTML(Guid moduleId, HttpRequest request)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<div style=\"padding:3px;\">");
            sb.Append("<div class=\"tree-searchbox\">");
        ...
        public override string GetSetRoleFormHTML(Guid roleId)
        {
            ...
            sb.Append("<div class=\"content txContent\">");
        ...
        public override string GetQuickEditFormHTML(Guid moduleId, Guid roleId, Guid? formId)
        {
            ...
            Sys_Role role = CommonOperate.GetEntityById<Sys_Role>(roleId, out errMsg);
            Sys_Module module = SystemOperate.GetModuleById(moduleId);
            bool hasParent = module.ParentId.HasValue && module.ParentId.Value != Guid.Empty;
            List<string> primaryFields = string.IsNullOrWhiteSpace(module.PrimaryKeyFields) ? new List<string>() : module.PrimaryKeyFields.Split(",".ToCharArray()).ToList();
            string titleKey = module.TitleKey;
            string titleKeyFieldId = string.Empty;
            ...
            if (hasParent)
            {
                List<Sys_FormField> parentFormFields = SystemOperate.GetDefaultFormField(module.ParentId.Value);
                leftFormFields.AddRange(parentFormFields);
            }
            ...
            sb.Append("<table id=\"leftGrid\" class=\"easyui-datagrid\" style=\"width: 180px; height: 315px;\" data-options=\"fitColumns:true,selectOnCheck:true,checkOnSelect:true,rownumbers:true,idField:'Id'" + otherOptions + "\">");
            sb.Append("<thead>");
            sb.Append("<tr>");
            sb.Append("<th data-options=\"field:'Id',checkbox:true\"></th>");
            sb.Append("<th data-options=\"field:'FieldName',hidden:true,width:0\">字段名称</th>");
            ...
            if (leftFormFields != null && leftFormFields.Count > 0)
            {
                ...
                foreach (Sys_FormField field in leftFormFields)
                {
                    ...
                    {
                        Sys_Field sysField = SystemOperate.GetFieldById(field.Sys_FieldId.Value);
                        string currFieldModuleName = sysField.Sys_ModuleId.HasValue ? SystemOperate.GetModuleNameById(sysField.Sys_ModuleId.Value) : string.Empty;
                        sb.AppendFormat("<td>{0}</td>", currFieldModuleName);
            ...
            sb.Append("</td>");
            sb.Append("<td>");
            sb.Append("<table id=\"rightGrid\" class=\"easyui-datagrid\" style=\"width: 380px; height: 315px;\" data-options=\"fitColumns:true,selectOnCheck:true,checkOnSelect:true,rownumbers:true,idField:'Id'\">");
            sb.Append("<thead>");
            sb.Append("<tr>");
            sb.Append("<th data-options=\"field:'Id',checkbox:true\"></th>");
            sb.Append("<th data-options=\"field:'FieldName',hidden:true,width:0\">字段名称</th>");
        ...
        public override string GetSetUserRoleHTML(Guid userId)
        {
            ...
            StringBuilder sb = new StringBuilder();
            //获取所有角色
            List<Sys_Role> roles = CommonOperate.GetEntities<Sys_Role>(out errMsg, x => x.IsDeleted == false && x.IsDraft == false && x.IsValid == true, null, false);
            //构造HTML
            sb.Append("<div style=\"padding:10px\">");
            sb.Append("<table>");
            if (roles != null && roles.Count > 0)
            {
                for (int i = 0; i < roles.Count; i++)
                {
                    ...
                    Sys_UserRole userRole = CommonOperate.GetEntity<Sys_UserRole>(x => x.Sys_RoleId == role.Id && x.Sys_UserId == userId && x.IsDeleted == false && x.IsDraft == false, null, out errMsg);
                    if (userRole != null)
                    {
        ...
        public override string GetSetRolePermissionHTML(Guid? roleId)
        {
            ...
            string where = string.Format("Id IN(SELECT Sys_UserId FROM dbo.Sys_UserRole WHERE Sys_RoleId='{0}' AND IsDeleted=0 AND IsDraft=0)", roleId.HasValue ? roleId.Value.ToString() : Guid.Empty.ToString());
        ...
        public override string GetSetUserPermissionHTML(Guid? userId)
        {
            ...
            if (!userId.HasValue || userId.Value == Guid.Empty) //从用户列表点击进入
            {
                ...
                sb.Append("<li style=\"margin:10px 0 0 10px \">");
                sb.Append("<label style=\"color: #607d8b; \">&nbsp;检索：</label>");
                sb.Append("<input type=\"text\" id=\"userTxt\" class=\"ipt \" style=\"width: 90px;\" />");
                sb.Append("&nbsp;<a href=\"javascript:void(0);\" style=\"padding: 2px 0;\" title=\"搜索\" onclick=\"SearchUser()\" class=\"easyui-linkbutton btnwhite\" data-options=\"iconCls:'eu-icon-search'\"></a>");
                sb.Append("</li>");
                sb.Append("</ul>");
            ...
            sb.Append("<table class=\"qxContentTable \"><tr>");
            sb.Append("<td style=\"width:300px;\">");
            sb.Append("<label  style=\"margin-left:10px\">&nbsp;按大模块检索：</label>");
            List<Sys_Menu> topMenus = SystemOperate.GetTopMenus(true, CurrUser);
            ...
            if (!userId.HasValue || userId.Value == Guid.Empty) //从用户权限菜单中点击进入
            {
                ...
                sb.Append("<a id=\"btnCancel\" style=\"margin-right:10px;\" href=\"#\" class=\"easyui-linkbutton btnwhite\" data-options=\"iconCls:'eu-icon-cancel'\" onclick=\"CloseTab()\">关 闭</a>");
                sb.Append("<a id=\"btnClear\" style=\"margin-right:10px;\" href=\"#\" class=\"easyui-linkbutton btnwhite\" data-options=\"iconCls:'eu-icon-clear'\" onclick=\"ClearUserPermission()\">清除权限</a>");
            }
            sb.Append("</td>");
            sb.Append("</tr></table>");
            sb.AppendFormat("<table id=\"tb_permission\" h=\"{0}\" class=\"easyui-datagrid\" style=\"width:99%px;height:{0}px\"", h.ToString());
        ...
        public override string GetDesktopIndexHTML()
        {
            ...
            if (desktopItems.Count > 0)
            {
                ...
                int w = CurrUser.ClientBrowserWidth - ConstDefine.MAIN_LEFT_MENU_WIDTH - ConstDefine.GRID_FIX_HEIGHT - 4;
                int tw = (int)(w / 2);
                sb.AppendFormat("<div id=\"pp\" style=\"width:{0}px;min-width:350px;overflow-x:hidden;\">", w.ToString());
                for (int j = 0; j < 2; j++) //桌面设置两列
                {
                    //--column--start
                    sb.AppendFormat("<div style=\"width:{0}px;\">", tw);
                    for (int i = j; i < desktopItems.Count; i += 2)
                    {
                        if (desktopItems[i].Desktop_ItemTabs != null && desktopItems[i].Desktop_ItemTabs.Count > 0)
                        {
                            ...
                            if (hasTabs)
                            {
                                sb.Append("<div id=\"deskItem_" + i.ToString() + "\" class=\"easyui-tabs\" fit=\"false\" style=\"height:260px\" data-options=\"tabHeight:" + ConstDefine.TAB_HEAD_HEIGHT.ToString() + ",tools:'#tab-tools_" + i.ToString() + "',onSelect:function(title,index){if(typeof(OnSelectTab)=='function'){OnSelectTab(title,index," + i.ToString() + ");}}\">");
                            ...
                            {
                                sb.AppendFormat("<div id=\"deskPanel_{0}_{1}\" flag=\"{6}\" title=\"{2}\"{4}><iframe scrolling=\"auto\" frameborder=\"0\" class=\"ifr\" url=\"{3}\" hastab=\"{5}\" style=\"width:100%;height:100%;\"></iframe>", i.ToString(), deskItemTab.Id.ToString(), deskItemTab.Title, deskItemTab.Url.ObjToStr(), hasTabs ? string.Format(" style=\"height:229px;width:{0}px;min-width:328px;\"", (tw - 20).ToString()) : string.Format(" style=\"height:260px\" data-options=\"tools:'#tab-tools_{0}'\"", i.ToString()), hasTabs ? "1" : "0", deskItemTab.Flag.ObjToStr());
        ...
        /// <returns></returns>
        public override string GetDesktopGridHTML(Guid moduleId, int top = 5, string sortName = "AutoIncrmId", bool isDesc = true, Dictionary<string, object> dic = null, HttpRequest request = null)
        {
            StringBuilder sb = new StringBuilder();
            ...
            if (fields.Count > 0)
            {
                ...
                gridParams.GridFields = gridFields;
                CommonOperate.ExecuteCustomeOperateHandleMethod(moduleId, "GridParamsSet", new object[] { DataGridType.DesktopGrid, gridParams, request });
                ...
                foreach (Desktop_GridField field in fields)
                {
                    ...
                    string formatter = SystemOperate.GetGridFormatFunction(moduleId, field.FieidName);
        ...
        public override string GetFlowDesignHTML()
        {
            ...
            sb.Append("</div>");
            sb.Append("</div>");
            sb.Append("<div data-options=\"region:'center',title:'流程画布'\" style=\"height: 99%; width: 80%; overflow: hidden\">");
            ...
            sb.Append("<div title=\"流程导航\" style=\"overflow: hidden;\">");
            sb.Append("<iframe scrolling=\"auto\" frameborder=\"0\" src=\"\" style=\"width: 100%; height: 100%;\"></iframe>");
            sb.Append("</div>");
            sb.Append("</div>");
            sb.Append("</div>");
            sb.Append("<!--右键菜单-->");
            ...
            sb.Append("<!--增加右键删除功能-->");
            sb.Append("<div id=\"del\" data-options=\"iconCls:'eu-icon-del'\" onclick=\"DeleteNode()\">删除</div>");
        ...
        public override string GetFlowTipsHTML(Guid moduleId, Guid recordId)
        {
            ...
            object obj = null;
            if (SystemOperate.IsDetailModule(moduleId) && !BpmOperate.IsEnabledWorkflow(moduleId)) //当前为明细模块并且未启用流程
            {
                string errMsg = string.Empty;
                Type detailModelType = CommonOperate.GetModelType(moduleId);
                tempModuleId = SystemOperate.GetParentModuleId(moduleId);
                string foreignField = string.Format("{0}Id", SystemOperate.GetModuleTableNameById(tempModuleId));
                obj = CommonOperate.GetEntityById(moduleId, recordId, out errMsg, new List<string>() { foreignField, "CreateUserName", "FlowStatus" });
                PropertyInfo p = detailModelType.GetProperty(foreignField);
                tempRecordId = p.GetValue2(obj, null).ObjToGuid();
            }
            Bpm_WorkFlowInstance workflowInst = BpmOperate.GetWorkflowInstance(tempModuleId, tempRecordId);
            if (workflowInst == null)
            {
                string errMsg = string.Empty;
                List<Guid?> workflowIds = BpmOperate.GetAllWorkflows(x => x.Sys_ModuleId == tempModuleId).Select(x => (Guid?)x.Id).ToList();
                Bpm_WorkFlowInstanceHistory workflowInstHistory = workflowIds.Count > 0 ? CommonOperate.GetEntity<Bpm_WorkFlowInstanceHistory>(x => workflowIds.Contains(x.Bpm_WorkFlowId) && x.RecordId == tempRecordId, null, out errMsg) :
                                                                 CommonOperate.GetEntity<Bpm_WorkFlowInstanceHistory>(x => x.Bpm_WorkFlowId == workflowIds.FirstOrDefault().Value && x.RecordId == tempRecordId, null, out errMsg);
            ...
            object objStr = CommonOperate.ExecuteCustomeOperateHandleMethod(tempModuleId, "GetFlowTipsHTML", new object[] { tempRecordId, workflowInst != null ? workflowInst.StatusOfEnum : WorkFlowStatusEnum.NoStatus, CurrUser });
            ...
            else
            {
                string errMsg = string.Empty;
                if (obj == null)
                    obj = CommonOperate.GetEntityById(moduleId, recordId, out errMsg, new List<string>() { "CreateUserName", "FlowStatus" });
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<div class=\"content bgblue\">");
