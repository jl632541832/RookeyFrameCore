...
namespace Rookey.Frame.Common
{
    public class UploadFileManager
    {
        ...
        public static string Save(IFormFile file, string fileName, string configName)
        {
        ...
        /// <param name="file">文件信息</param>
        /// <param name="cfg">上传配置信息</param>
        public static void Check(IFormFile file, UploadConfig cfg)
        {
            ...
            //检查文件大小是否超过限制
            if ((file.Length / 1024) > cfg.MaxFileSize)
            {
        ...
        /// <param name="cfg">上传配置信息</param>
        /// <returns>返回地址</returns>
        public static string Save(IFormFile file, string fileName, UploadConfig cfg)
        {
            Check(file, cfg);
            ...
            return Save(file.OpenReadStream(), fileName, ext, cfg);
        }
        ...
        public static string SaveAs(IFormFile file, string configName)
        {
        ...
        /// <param name="customerFileName">自定义文件名</param>
        /// <returns>新保存文件路径信息</returns>
        public static string SaveAs(IFormFile file, string configName, string fileName, string customerFileName = null)
        {
            var cfg = GetUploadConfig(configName);
        ...
        /// <param name="customerFileName">自定义文件名</param>
        /// <returns>新保存文件路径信息</returns>
        public static string SaveAs(IFormFile file, UploadConfig cfg, string customerFileName = null)
        {
        ...
        /// <param name="configName">上传配置信息节点名称</param>
        /// <returns>新保存文件路径信息</returns>
        public static string SaveAsTemporary(IFormFile file, string configName)
        {
            var cfg = GetUploadConfig(configName);
        ...
        /// <param name="cfg">上传配置信息</param>
        /// <returns>新保存文件路径信息</returns>
        public static string SaveAsTemporary(IFormFile file, UploadConfig cfg)
        {
            string ext = Path.GetExtension(file.FileName);
