...
namespace Rookey.Frame.DAL.Sys
{
    ...
    internal static class ObjectReferenceClass
    {
        ...
        /// <param name="currUser">当前用户</param>
        /// <returns></returns>
        public static List<Guid> GetChildEmpIds(UserInfo currUser)
        {
            if (currUser == null || !currUser.EmpId.HasValue)
        ...
        /// <param name="powerSql">条件语句</param>
        /// <param name="currUser">当前用户</param>
        /// <returns></returns>
        public static string ReplaceRoleDataPowerCustomerParams(Guid moduleId, string powerSql, UserInfo currUser)
        {
