...
namespace Rookey.Frame.Bridge
{
    ...
    public static class BridgeObject
    {
        ...
        /// 默认实体层DLL
        /// </summary>
        private const string DEFAULT_MODEL_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 默认业务层接口DLL
        /// </summary>
        private const string DEFAULT_IBLL_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 默认业务层DLL
        /// </summary>
        private const string DEFAULT_BLL_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 默认数据层接口DLL
        /// </summary>
        private const string DEFAULT_IDAL_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 默认数据层DLL
        /// </summary>
        private const string DEFAULT_DAL_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 实体类型缓存键
        /// </summary>
        ...
        /// 默认操作层dll
        /// </summary>
        private const string DEFAULT_OPERATE_DLL = "Rookey.FrameCore";
        /// <summary>
        /// 自定义操作处理类型
        /// </summary>
