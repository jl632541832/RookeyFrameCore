...
namespace Rookey.Frame.IBLL.Base
{
    /// <summary>
    /// 通用业务层接口
    /// </summary>
    ...
    public interface IBaseBLL<T> where T : class
    {
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        List<T> GetEntitiesByField(out string errorMsg, string fieldName, object fieldValue, Expression<Func<T, bool>> expression = null, string where = null, bool permissionFilter = true, List<string> orderFields = null, List<bool> isDescs = null, int? top = null, List<string> fieldNames = null, bool references = false, string connString = null);
        ...
        bool UpdateEntity(T entity, out string errorMsg, List<string> fieldNames = null, bool permissionValidate = true, bool references = false, string connString = null, IDbConnection transConn = null);
        ...
        /// <param name="transConn">事务连接对象</param>
        /// <returns></returns>
        bool UpdateFields(List<T> entities, out string errMsg, List<string> fieldNames, string connString = null, IDbConnection transConn = null);
        ...
        /// <param name="transConn">事务连接对象</param>
        /// <returns></returns>
        bool UpdateEntityByExpression(object obj, Expression<Func<T, bool>> expression, out string errMsg, string connString = null, IDbConnection transConn = null);
        ...
        /// <returns></returns>
        List<T> GetEntitiesBySql(out string errorMsg, string sql, object[] sqlParams = null, string connString = null);
        ...
        /// <param name="transConn">事务连接对象</param>
        /// <returns></returns>
        int ExecuteNonQuery(out string errorMsg, string sql, Dictionary<string, object> sqlParams = null, string connString = null, IDbConnection transConn = null);
