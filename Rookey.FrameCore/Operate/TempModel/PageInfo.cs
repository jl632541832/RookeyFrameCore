...
namespace Rookey.Frame.Operate.Base.TempModel
{
    ...
    public class PageInfo
    {
        ...
        /// <returns></returns>
        public static PageInfo GetPageInfo(HttpRequest request, string defaultSortField = "AutoIncrmId")
        {
            string pageStr = request.QueryEx(PageInfo.pageIndexKeyWord).ObjToStr();
            int _page = pageStr.ObjToInt();
            ...
            string pagesizeStr = request.QueryEx(PageInfo.pageSizeKeyWord).ObjToStr();
            int _pagesize = pagesizeStr.ObjToInt();
            if (_pagesize <= 0) _pagesize = 10;
            string sortname = request.QueryEx(PageInfo.sortFieldKeyWord).ObjToStr();
            string sortorder = request.QueryEx(PageInfo.sortOrderKeyWord).ObjToStr();
