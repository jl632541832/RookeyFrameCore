    ...
    public class NPOI_ExcelBatchExport
    {
        ...
        protected static IWorkbook OpenOrCreateExcelFile(string filePath)
        {
            ...
            if (!File.Exists(filePath))
            {
                ...
                IWorkbook tempWorkbook = hssfWorkbook;
            ...
            IWorkbook workbook = new HSSFWorkbook(new POIFSFileSystem(fs));
            return workbook;
        }
        ...
        protected static void InsertCell(DataTable dtSource, DataRow drSource, IRow currentExcelRow, ISheet excelSheet, IWorkbook excelWorkBook, ICellStyle dateCellStyle = null)
        {
            for (int cellIndex = 0; cellIndex < dtSource.Columns.Count; cellIndex++)
            {
                ...
                switch (rowType.ToString())
                {
                    ...
                    case "System.DateTime"://日期类型
                        ...
                        //格式化显示
                        ICellStyle cellStyle = dateCellStyle;
                        if (cellStyle == null)
                        {
                    ...
                    case "System.Byte":
                        ...
                        newCell = currentExcelRow.CreateCell(cellIndex);
                        string intValue = intV.ToString().Split(".".ToCharArray(), StringSplitOptions.RemoveEmptyEntries).FirstOrDefault();
